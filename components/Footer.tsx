        ...
        <footer className='w-full pb-10 mb-[100px] md:mb-5' id='contact'>
            ...
            <div className='flex flex-col items-center'>
                <h1 className='heading lg:max-w-[45vw]'>
                    Ready to take <span className='text-purple'>your</span> digitgal
                    presence to the next level?
                </h1>
                <p className='text-white-200 md:mt-10 my-5 text-center'>
                    Reach out to me today and let&apos;s discuss how I can help you achieve your goals.
                </p>
                <a href='mailto:mostafa0falcon@gmail.com'>
                    <MagicButton
            ...
            <div className='flex mt-16 md:flex-row flex-col
             justify-between items-center'>
                ...
                <div className='flex items-center md:gap-3 gap-6 my-3 md:my-1'>
